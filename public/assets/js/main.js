...
$(function () {
  ...
  MINOVATE.global = {
    ...
    layout: function () {
      var defaultHeaderScheme = "scheme-default",
        ...
        defaultAppClasses =
          "scheme-default default-scheme-color header-fixed aside-fixed rightbar-hidden";
    ...
    menu: function () {
      if ($dropdowns.length > 0) {
        ...
        $a.on("click", function (event) {
          if (
            $app.hasClass("sidebar-sm") ||
            $app.hasClass("sidebar-xs") ||
            $app.hasClass("hz-menu")
          ) {
            return false;
          }
  ...
  MINOVATE.isMobile = {
    ...
    any: function () {
      return (
        MINOVATE.isMobile.Android() ||
        MINOVATE.isMobile.BlackBerry() ||
        MINOVATE.isMobile.iOS() ||
        MINOVATE.isMobile.Opera() ||
        MINOVATE.isMobile.Windows()
      );
    },
  };
